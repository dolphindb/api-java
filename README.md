...
Users may get data from other database systems or third-party APIs and store the data in DolphinDB database. This section describes uploading and saving the data retrieved through the Java API.
