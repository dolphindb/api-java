            ...
            while (isContinue){
                ...
                while (isContinue){
                    try {
                        ...
                        if (writer.insert(curIndex++, "Symbol" + String.valueOf(random.nextInt() % 100), "String" + String.valueOf(random.nextInt() % 100), a).getErrorInfo() != ""){
                            System.out.println(pErrorCodeInfo.getErrorInfo());
                        }
                        System.out.print(".");
                        Thread.sleep(1000);
                    }catch (Exception e){
