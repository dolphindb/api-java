...
public class EntrustDataWriter implements Runnable {
	...
	public EntrustDataWriter(String key, int id, int insertCount, ArrayList data, MultithreadedTableWriter mtw) {
		this.key = key;
		this.id = id;
...
//	}
	...
	public void run() {
		...
		for (int i = 0; i < subData.size(); i++) {
			...
			//System.out.println("thread:" + id + ",key:" + key + ",insert=" + i);
		}
	}
}