...
public class TickSlowDataWriter implements Runnable{
...
//	public static List<Object[]> data;
	...
	public TickSlowDataWriter(String key, int id, int insertCount, ArrayList data, MultithreadedTableWriter mtw) {
		this.key = key;
		this.id = id;
