...
public class TickTableWriter implements Runnable{
	...
	public TickTableWriter(int id, ArrayList<BasicTable> data, String dbName, String tableName, int insertCount) throws IOException {
