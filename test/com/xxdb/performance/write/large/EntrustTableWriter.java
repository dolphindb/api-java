...
public class EntrustTableWriter implements Runnable{
	...
	public EntrustTableWriter(int id, ArrayList<BasicTable> data, String dbName, String tableName, int insertCount) throws IOException {
