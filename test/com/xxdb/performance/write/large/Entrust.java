...
public class Entrust {
	...
	public static String dbName = "dfs://SH_TSDB_entrust";
	public static String tableName = "entrust";
	public static String writeDBName = "dfs://entrust_table";
	public static String writeTableName = "entrust";
...
//		EntrustTableWriter.nodeList = nodeList;
//	}
	...
	public static void write(ArrayList<ArrayList<BasicTable>> lists) throws Exception {
		for (int i = 0; i < lists.size(); i++) {
			new Thread(new EntrustTableWriter(i, lists.get(i), writeDBName, writeTableName, insertCount)).start();
		}
	}
...
//			String sql = String.format("t = select top %s * from loadTable('%s','%s') where date(TransactTime) = 2021.01.04;", rows, dbName, tableName);
//			conn.run(sql);
...
//				sql = "update t set TransactTime = temporalAdd(TransactTime,1,'d');t;";
...
//		while (true) {
//			Thread.sleep(1);
//			if (EntrustTableWriter.cdl.get() == threadNum)
//				break;
//		}
