...
public class BasicInt128VectorTest {
    ...
    @Test
    public void test_BasicInt128Vector_array11() throws Exception {
        Long2[] arr = new Long2[]{new Long2(888L,800L)};
        BasicInt128Vector bi128v = new BasicInt128Vector(arr,false);
        assertEquals("00000000000003780000000000000320",bi128v.get(0).getString());
        //assertEquals("",bi128v.get(2).getString());
    }
    ...
    @Test
    public void test_BasicInt128Vector_capacity_lt_size() throws Exception {
        BasicInt128Vector bbv = new BasicInt128Vector(5,1);
        bbv.set(0, (Object)null);
        bbv.set(1, null);
        bbv.set(2, new Long2(888L,800L));
        bbv.set(3,new Long2(0L,0L));
        bbv.set(4, new Long2(220L,25L));
        Assert.assertEquals("[,,00000000000003780000000000000320,,00000000000000dc0000000000000019]", bbv.getString());
    }

    @Test
    public void test_BasicInt128Vector_size_capacity_set() throws Exception {
        BasicInt128Vector bbv = new BasicInt128Vector(5,6);
    ...
    @Test
    public void test_BasicInt128Vector_size_capacity_add() throws Exception {
        BasicInt128Vector bbv = new BasicInt128Vector(0,6);
        Assert.assertEquals("[]", bbv.getString());
        bbv.add((Object)null);
        bbv.add(null);
    ...
    @Test
    public void test_BasicInt128Vector_set_type_not_match() throws Exception {
        BasicInt128Vector bbv = new BasicInt128Vector(1,1);
        String re = null;
        try{
            bbv.set(0,1);
        }catch(Exception e){
    ...
    @Test
    public void test_BasicInt128Vector_add_type_not_match() throws Exception {
        BasicInt128Vector bbv = new BasicInt128Vector(1,1);
        String re = null;
        try{
            bbv.add(1);
