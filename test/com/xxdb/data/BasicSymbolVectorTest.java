...
public class BasicSymbolVectorTest {
    ...
    @Test
    public void test_BasicSymbolVector_capacity_lt_size() throws Exception {
        BasicSymbolVector bbv = new BasicSymbolVector(6,1);
    ...
    @Test
    public void test_BasicSymbolVector_size_capacity_set() throws Exception {
        BasicSymbolVector bbv = new BasicSymbolVector(6,6);
    ...
    @Test
    public void test_BasicSymbolVector_size_capacity_add() throws Exception {
        BasicSymbolVector bbv = new BasicSymbolVector(0,6);
        Assert.assertEquals("[]", bbv.getString());
        String re = null;
        try{
            bbv.add((Object)null);
        ...
        assertEquals("SymbolVector does not support add", re);
    }

    @Test
    public void test_BasicSymbolVector_set_type_not_match() throws Exception {
        BasicSymbolVector bbv = new BasicSymbolVector(1,1);
        String re = null;
        try{
            bbv.set(0,1);
        }catch(Exception e){
    ...
    @Test
    public void test_BasicSymbolVector_add_type_not_match() throws Exception {
        BasicSymbolVector bbv = new BasicSymbolVector(1,1);
        String re = null;
        try{
            bbv.add(1);
        ...
        assertEquals("java.lang.Integer cannot be cast to java.lang.String", re);
    }
