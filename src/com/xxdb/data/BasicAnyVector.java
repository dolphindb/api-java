...
public class BasicAnyVector extends AbstractVector {
	...
	public boolean isNull(int index) {
		return values.get(index) == null || (values.get(index).isScalar() && ((Scalar)values.get(index)).isNull());
	}

	@Override
	public void setNull(int index) {
		values.set(index, new Void());
	}
