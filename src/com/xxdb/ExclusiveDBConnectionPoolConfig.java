...
public class ExclusiveDBConnectionPoolConfig {
    ...
    public ExclusiveDBConnectionPoolConfig() {
    }
    ...
    protected void validate() {
        ...
        if (minimumPoolSize <= 0) {
            minimumPoolSize = 5;
            log.warn("The param 'minimumPoolSize' cannot less than or equal to 0, will use the default value 5.");
        }
        ...
        if (maximumPoolSize < minimumPoolSize) {
            ...
            log.warn("The param 'maximumPoolSize' cannot less than 'minimumPoolSize', 'maximumPoolSize' will be set equal to 'minimumPoolSize' value.");
        }
